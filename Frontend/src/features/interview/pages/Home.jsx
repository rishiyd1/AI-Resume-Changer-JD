...
const Home = () => {
    ...
    if (loading) {
        return <Spinner text="Loading your interview plan..." />
    }
                                ...
                                <div className='dropzone dropzone--uploaded'>
                                    <div className='dropzone__file-info'>
                                        ...
                                        <div className='dropzone__file-details'>
                                            ...
                                            <p className='dropzone__file-size'>{formatFileSize(resumeFile.size)}</p>
                                        </div>
                                        <button className='dropzone__remove-btn' onClick={handleRemoveFile} title='Remove file'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
                                        </button>
                                    </div>
                                    <div className='dropzone__success-bar' />
                                </div>
                            ) : (
                    ...
                    <ul className='reports-list'>
                        {reports.map(report => (
                            <li key={report._id} className='report-item' onClick={() => navigate(`/interview/${report._id}`)}>
                                <button className='report-item__delete' onClick={(e) => handleDeleteReport(e, report._id)} title='Delete report'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
                                </button>
